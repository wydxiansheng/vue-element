      ...
      <div class="container">
        ...
        <div class="navbar-header page-scroll">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <span class="icon-bar" style="background:#f6f6f6"></span>
            <span class="icon-bar" style="background:#f6f6f6"></span>
            <span class="icon-bar" style="background:#f6f6f6"></span>
      		</button>
          <a class="navbar-brand page-scroll" href="#page-top" @click="homePager()"><img src="../../assets/zxdl-logo1.png" alt="Lattes theme logo" class="Imgs "></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav cl">
                                ...
                                <el-dropdown-menu slot="dropdown"  class="dropCsbse">
                                    <el-dropdown-item >
                                        <p class="row text-center"> 
                                            ...
                                            <span @click="cloundPlgn" class="col-md-4 col-xs-12">ZXDL社群</span>
                                        </p>
                                    </el-dropdown-item>
                                </el-dropdown-menu>
                         </el-dropdown>              
           ...
           <!-- <li><a class="page-scroll  hovers" @click="yyshic" ><span class="el-dropdown-link" :class="active=='5'?'border_active':''">应用市场</span></a></li>-->
            ...
            <li><a class="page-scroll  hovers" @click="getPeople"><span  :class="active=='9'?'border_active':''" class="el-dropdown-link">招贤纳士</span></a></li>
...
$(window).scroll(function(){
    if($(this).scrollTop() > 50){
        $('.navbar').css("background","#f5f7fa")
    }else if($(this).scrollTop() < 50){
        $('.navbar').css("background","#ffffff42")
    }
    if($(this).scrollTop() > 50){
...
export default { 
    ...
    methods: {
      ...
      getPeople:function(){
           this.$router.push({path: '/getPeople'})
      },
