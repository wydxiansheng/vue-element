             ...
             <div class="lcss">
                     <div class="container">
                        <div class="" style="margin:0 auto!important;width:100%;height:70px;line-height:70px;">
                            <span class="spanshover spanbot" @click="Upclouds"><i class="iconfont icon-iconqyxx"></i> 初学者</span><span class="spanshover spanbos" style="margin-left:120px;" @click="moneyCloud"><i class="iconfont icon-yun2"></i> 非初学者</span>
                        </div>
                     </div>
             </div>
             <div class="kong"></div>
                 ...
                 <div class="container erfs whyContainer" style="margin-bottom:70px;">
                    ...
                    <div class="row text-center bjia">
                        <div>
                            <div class="col-md-4">
                                <div class="bjia-poai">
                                    <div class="text-right bjia-title">深度IT技术了解</div>
                                ...
                                <div class="bjia-poai poai">
                                    <div class="text-right bjia-title">IT人从业</div>
                                    <ul class="text-right bjia-uls">
                                        <li>VIP专家服务+平台化服务，专业、安全和可靠</li>
                                        <li>完善的学习服务体系，7*24的保障服务 </li>
                                        <li>更加专业的从业指导方案</li>
                                        <li>更加安全的从业规划指导</li>
                                        <li>更加可靠的合作伙伴媒介</li>
                                    </ul>
                            ...
                            <div class="col-md-4 img-position">
                                ...
                                <div class="sji">
                                    <ol class="text-center">
                                        ...
                                        <li  class="ol-lit">多样式解决方案</li>
                                    </ol>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="bjia-posi">
                                    <div class="text-left bjia-title">顾问咨询</div>
                                    <ul class="text-left bjia-ules">
                                        <li>1V1式IT咨询服务，顾问助力技术认知</li>
                                        <li>线上咨询和线下服务相结合，省时、省钱和专业</li>
                                        <li>顾问提供IT学习方向及专业建议</li>
                                        <li>提供完整和专业的初学者个人分析报告</li>
                                        <li class="bjia-kong">&nbsp</li>
                                    </ul>
                                    <img src="../../../assets/er-icon/banner11.png" alt="">
                                </div>
                                <div class="bjia-posi posi">
                                    <div class="text-left bjia-title">IT学习</div>
                                    <ul class="text-left bjia-ules">
                                        <li>1V1式IT咨询服务，顾问助力技术学习</li>
                                        <li>20分钟内完成规划、选型和方向制定</li>
                                        <li>全程式为IT初学者提供技术指导及帮助</li>
                                        <li>提供心理辅导及疑难解答</li>
                                        <li class="bjia-kong">&nbsp</li>
                                    </ul>
...
.rusetb{
    background:url("../../../assets/er-icon/bg9.png") no-repeat;
...
@media (max-width: 768px) {
   ...
   *{margin:0px;padding:0px;}
   ...
   .seleconeMain-mainfir .selecone-pfir span{
       font-weight:100;
       color:#ccc;
   }
   ...
   .seleconeMain-simg ul li .sp3{
    ...
    .seleconeMain-simg ul{
        margin-top:20px;
    }
     .seleconeMain-simg ul li span{
         margin-right:5px;
     }
